        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<h4 class="page-title">Data Kompetensi Sub Ordinat Mutasi</h4>
						</div>
					</div>
                                ...
                                <table class="table table-striped custom-table m-b-0 display" id="tabel2">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><a href="detail_jabatan_kompetensi_mutasi.php?id_jabatan_lama=<?php echo $data['id_jabatan_dinilai']."&&id_departemen_lama=".$data['id_departemen_dinilai']."&&id_unit_lama=".$data['id_unit_dinilai']; ?>">Detail</a></td>
                                            </tr>
                                    <?php
                                        }
                                    ?>
