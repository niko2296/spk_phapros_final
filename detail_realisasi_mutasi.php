        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
                                    ...
                                    if($input == 2)
                                    {
                                        echo '
                                            <script>
                                                ...
                                                window.location = "detail_realisasi_mutasi.php?id_anggota='.$id_anggotaD.'&&id_jabatan_lama='.$id_jabatanD.'&&id_departemen_lama='.$id_departemenD.'&&id_unit_lama='.$id_unitD.'";
                                            </script>
                                        ';
                                    }
                                    if($input == 1)
                    ...
                    <div class="row">
                        <div class="col-md-12" align="right">
                            <a class="btn btn-warning" href="detail_kpi_verifikasi_mutasi.php?id_jabatan_lama=<?php echo $id_jabatanD."&&id_departemen_lama=".$id_departemenD."&&id_unit_lama=".$id_unitD; ?>">Kembali Halaman Sebelumnya</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            {    
                ...
                $('.table').on('change','#verifikasi1',function(e){
                    ...
                    var id1 = 'realisasi';
                    var id2 = 'keterangan';
                    var lokasi = "detail_realisasi_mutasi.php?id_anggota="+ id_anggota +"&&id_jabatan_lama="+ id_jabatan +"&&id_departemen_lama="+ id_departemen +"&&id_unit_lama="+ id_unit;
                    $.ajax({
