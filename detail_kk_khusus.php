        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<h4 class="page-title">Data Kompetensi Khusus Berdasarkan Kelompok Jabatan (<b>Periode 
                                <?php
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php
                                ...
                                {
                                    $eksekusi = $db->copy_kompetensi_khusus(2, $_POST['id_copy'], $_POST['periode']);
					...
					<div class="row" style="border:1px solid black;color:black; background-color:white; padding:1%;">
							...
							<div class="table-responsive">
                                <table class="table table-striped custom-table m-b-0 display" id="tabel">
                                    ...
                                    <?php
                                        $no = 0;
                                        error_reporting(0);
                                        foreach($db->tampil_kelompok_khusus($id_periode) as $data)
                                        {
                                            $no = $no+1;
                                    ?>
                                            <tr>
                                                ...
                                                <td>(Jumlah Kompetensi Khusus : <?php echo $db->hitung_kompetensi_khusus($id_periode, $data['id_jabatan'], $data['id_departemen'], $data['id_unit']); ?>) <a href="detail_kompetensi_khusus.php?id_periode=<?php echo $id_periode."&&id_jabatan=".$data['id_jabatan']."&&id_departemen=".$data['id_departemen']."&&id_unit=".$data['id_unit']; ?>">Detail</a></td>
                                            </tr>
                                    <?php
                                        }
                                    ?>
                        ...
                        <div class="col-md-12" align="right">
                            <a href="data_kompetensi_khusus.php" title="Kembali">
                                ...
                                <div class="modal-content modal-md">
                                    ...
                                    <form method="POST" action="#">
                                        <div class="modal-body card-box">
                                            ...
                                            <p>Yakin Untuk Meng-<i>copy</i> Kompetensi Khusus <?php echo "Pada Periode ".$tahun_asli; ?> ?</p>
