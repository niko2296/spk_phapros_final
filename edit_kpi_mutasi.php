        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<?php
                        foreach($db->tampil_kpi($idA, $id_anggotaD, $id_jabatanD, $id_departemenD, $id_unitD) as $tampilK)
                        {
						...
						{   
                            ...
                            if($eksekusi == 1)
                            {
                                header("location:detail_kpi_individu_mutasi.php?id_anggota=$id_anggotaD&&id_jabatan_lama=$id_jabatanD&&id_departemen_lama=$id_departemenD&&id_unit_lama=$id_unitD");
                            }
                        }
                    ?>
                    <!-- Form Kedua -->
