        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<h4 class="page-title">Data Kompetensi Matriks (Mutasi)</h4>
						</div>
					</div>
                    <!-- Tab Pertama -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped custom-table m-b-0 display" id="tabel">
                                    ...
                                    <?php
                                        $no = 0;
                                        error_reporting(0);
                                        foreach($db->tampil_jabatan_matriks2($departemenL) as $data)
                                        {
                                            $no = $no+1;
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $db->hitung_pegawai_mutasi($idA, $data['id_jabatan_lama'], $data['id_departemen_lama'], $data['id_unit_lama']); ?> Anggota</td>
                                                <td class="text-center  ">
                                                    <div class="dropdown">
                                                        <a href="detail_jabatan_matriks_mutasi.php?id_jabatan=<?php echo $data['id_jabatan_lama']."&&id_departemen=".$data['id_departemen_lama']."&&id_unit=".$data['id_unit_lama']; ?>">Detail</a>
                                                    </div>
                                                </td>
                                            </tr>
                                    <?php
