<?php
    ...
    $id_jabatanD2 = $_GET['id_jabatan'];
    $id_departemenD2 = $_GET['id_departemen'];
    $id_unitD2 = $_GET['id_unit'];
?>
<!DOCTYPE html>
<html>
    <head>
						...
						<div class="col-xs-8">
							<h4 class="page-title">
                                <?php
                                    ...
                                    echo 'Detail Anggota Kompetensi Matriks (Mutasi) <b>('.$nj.' - '.$nd.' - '.$nu.')</b>';
                                ?>
                            </h4>
						</div>
                        <div class="col-xs-4 text-right m-b-10">
                            <a class="btn btn-warning" href="kompetensi_matriks_mutasi.php">Kembali Pada Data Kompetensi Matriks</a>
                        </div>
					</div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <?php
                                                        ...
                                                        {
                                                    ?>
                                                            <a href="detail_km_mutasi.php?id_anggota=<?php echo $data['id_anggota']."&&id_jabatan=".$data['id_jabatan_lama']."&&id_departemen=".$data['id_departemen_lama']."&&id_unit=".$data['id_unit_lama']; ?>">Detail</a>
                                                    <?php 
                                                        }
                                                        else {
                                                            echo '-';
