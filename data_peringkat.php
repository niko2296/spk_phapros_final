        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-8">
							<h4 class="page-title">Master Peringkat Kompetensi</h4>
						</div>
						<div class="col-xs-4 text-right m-b-30">
							<a href="#" class="btn btn-primary rounded pull-right" data-toggle="modal" data-target="#add_ticket"><i class="fa fa-plus"></i> Tambah Peringkat</a>
						</div>
					</div>
					<div class="row">
                        ...
                        <?php
                            if(isset($_POST['tombolSimpan'])){
                                $eksekusi = $db->input_peringkat($_POST['id_periode'], $_POST['peringkat'], $_POST['nilai']);
                                if($eksekusi == 2)
                                {
                                ...
                                else if($eksekusi == 1)
                                {
                                    echo '
                                        <script>
                                            ...
                                            window.location = "data_peringkat.php";
                                        </script>
                                    ';
                                }
                            }
								...
								<table class="table table-striped custom-table m-b-0 display" id="tabel">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>(Jumlah Peringkat : <?php echo ($db->hitung_peringkat($data['id_periode'])); ?>) <a href="detail_peringkat.php?id_periode=<?php echo $data['id_periode']; ?>">Detail</a></td>
                                            </tr>
                                    <?php
                                        }
                                    ?>
				...
				<div class="modal-dialog">
					...
					<div class="modal-content modal-lg">
						<div class="modal-header">
							<h4 class="modal-title">Tambah Data Peringkat</h4>
						</div>
						<div class="modal-body">
							<form method="POST" action="#" id="polarisasi_input">
								<div class="row">
                                    ...
                                    <div class="col-md-6">
										<div class="form-group">
											<label>Peringkat Kompetensi</label>
											<input class="form-control cek" type="text" name="peringkat">
										</div>
									</div>
								</div>
                                <div class="row">
                                    <div class="col-md-6">
										<div class="form-group">
											<label>Nilai</label>
											<input class="form-control cek" type="text" name="nilai">
										</div>
									</div>
								</div>
								<div class="m-t-20 text-center">
									<button class="btn btn-primary" type="submit" name="tombolSimpan">Simpan Data Peringkat</button>
								</div>
							</form>
						</div>
					</div>
