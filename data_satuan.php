                ...
                <div class="content container-fluid">
					<div class="row">
						...
						<div class="col-xs-4 text-right m-b-30">
							<a href="#" class="btn btn-primary rounded pull-right" data-toggle="modal" data-target="#add_ticket"><i class="fa fa-plus"></i> Tambah Satuan</a>
						</div>
					</div>
					<div class="row">
						...
						<div class="modal-body">
							<form method="POST" action="#" id="satuan_input">
								...
								<div class="m-t-20 text-center">
									<button class="btn btn-primary" type="submit" name="tombolSimpan">Simpan Data Satuan</button>
								</div>
							</form>
						</div>
					</div>
