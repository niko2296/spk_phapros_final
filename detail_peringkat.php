        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<h4 class="page-title">Detail Peringkat (<b>Periode 
                                <?php
                        ...
                        <div class="col-md-12">
                            <?php
                                if(isset($_POST['tombolEdit'])){
                                    $eksekusi = $db->edit_peringkat($_POST['id_periode_edit'], $_POST['id_peringkat_edit'], $_POST['peringkat_edit'], $_POST['nilai_edit']);
                                ...
                                {
                                    $eksekusi = $db->hapus_peringkat($_POST['id_peringkat_hapus'], $id_periode);
                                    if($eksekusi == 2 || $eksekusi == 3)
                                    {
                                ...
                                {
                                    $eksekusi = $db->copy_peringkat(1, $_POST['id_copy'], $_POST['periode']);
                                    if($eksekusi == 2 || $eksekusi == 3)
                                    {
                                        echo '<div class="alert alert-danger">Data Gagal Disimpan</div>';
                                    }
                                ...
                                {
                                    $eksekusi = $db->copy_peringkat(2, $_POST['id_copy'], $_POST['periode']);
                                    if($eksekusi == 2 || $eksekusi == 3)
                                    {
                                        echo '<div class="alert alert-danger">Data Gagal Disimpan</div>';
                                    }
							...
							<div class="table-responsive">
                                <table class="table table-striped custom-table m-b-0 display" id="tabel">
                                    ...
                                    <?php
                                        $no = 0;
                                        error_reporting(0);
                                        foreach($db->tampil_peringkat($id_periode) as $data)
                                        {
                                            $no = $no+1;
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu pull-right">
                                                            <li><a href="#" title="Copy" data-toggle="modal" data-target="#copy<?php echo $data['id_peringkat']; ?>"><i class="fa fa-copy m-r-5"></i> Copy Data</a></li>
                                                            <?php
                                                                if($status_asli == 1)
                                                                {
                                                            ?>
                                                                    <li><a href="#" title="Edit" data-toggle="modal" data-target="#edit_ticket<?php echo $data['id_peringkat']; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a></li>
                                                                    <li><a href="#" title="Delete" data-toggle="modal" data-target="#delete_ticket<?php echo $data['id_peringkat']; ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a></li>
                                                            <?php
                                                                }
                                                            ?>
                                                        </ul>
                                            ...
                                            <!-- Modal Edit -->
                                            <div id="edit_ticket<?php echo $data['id_peringkat']; ?>" class="modal custom-modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    <div class="modal-content modal-lg">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Edit Data Peringkat</h4>
                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control cek" type="hidden" name="id_peringkat_edit" value="<?php echo $data['id_peringkat']; ?>">
                                                                            <input class="form-control cek" type="text" name="peringkat_edit" value="<?php echo $data['peringkat']; ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label>Nilai</label>
                                                                            <input class="form-control cek" type="text" name="nilai_edit" value="<?php echo $data['nilai']; ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="m-t-20 text-center">
                                                                    <button class="btn btn-primary" type="submit" name="tombolEdit">Edit Data Peringkat</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
                                            ...
                                            <!-- Modal Hapus -->
                                            <div id="delete_ticket<?php echo $data['id_peringkat']; ?>" class="modal custom-modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content modal-md">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Hapus Peringkat</h4>
                                                        </div>
                                                        <form method="POST" action="#">
                                                            <div class="modal-body card-box">
                                                                <p class="label label-danger">Menghapus Peringkat Ini Maka Menghilangkan History Seluruh Data Peringkat yang Telah Dihapus</p>
                                                                <br><br>
                                                                <p>Yakin Untuk Menghapus Peringkat <?php echo $data['peringkat']." Periode ".$tahun_asli; ?> ?</p>
                                                                <input type="hidden" name="id_peringkat_hapus" value="<?php echo $data['id_peringkat']; ?>">
                                            ...
                                            <!-- Modal Copy -->
                                            <div id="copy<?php echo $data['id_peringkat']; ?>" class="modal custom-modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content modal-md">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Copy Peringkat</h4>
                                                        </div>
                                                        <form method="POST" action="#">
                                                            <div class="modal-body card-box">
                                                                <p class="label label-danger">Otomatis Meng-<i>copy</i> Data Secara Lengkap</p>
                                                                <p>Yakin Untuk Meng-<i>copy</i> Peringkat <?php echo $data['peringkat']." Periode ".$tahun_asli; ?> ?</p>
                                                                <input type="hidden" name="id_copy" value="<?php echo $data['id_peringkat']; ?>">
