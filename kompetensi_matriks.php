        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<h4 class="page-title">Data Kompetensi Matriks</h4>
						</div>
					</div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped custom-table m-b-0 display" id="tabel">
                                            ...
                                            <?php
                                                $no = 0;
                                                error_reporting(0);
                                                foreach($db->tampil_jabatan_matriks($departemenL) as $data)
                                                {
                                                    $no = $no+1;
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo ($data['nama_unit'] == null)?('-'):($data['nama_unit']); ?></td>
                                                        <td><?php echo $db->hitung_jabatan_grup($data['id_jabatan'], $data['id_departemen'], $data['id_unit']); ?> Anggota</td>
                                                        <td class="text-center  ">
                                                            <div class="dropdown">
                                                                <a href="detail_jabatan_matriks.php?id_jabatan=<?php echo $data['id_jabatan']."&&id_departemen=".$data['id_departemen']."&&id_unit=".$data['id_unit']; ?>">Detail</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                            <?php
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped custom-table m-b-0 display" id="tabel2">
                                            ...
                                            <?php
                                                $no = 0;
                                                error_reporting(0);
                                                foreach($db->tampil_anggota_matriks($departemenL) as $data)
                                                {
                                                    $no = $no+1;
                                            ?>
                                                    <tr>
