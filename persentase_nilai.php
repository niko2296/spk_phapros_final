        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-8">
							<h4 class="page-title">Master Persentase Nilai</h4>
						</div>
						<div class="col-xs-4 text-right m-b-30">
							<a href="#" class="btn btn-primary rounded pull-right" data-toggle="modal" data-target="#add_ticket"><i class="fa fa-plus"></i> Tambah Persentase Nilai</a>
						</div>
					</div>
					<div class="row">
                        ...
                        <?php
                            if(isset($_POST['tombolSimpan'])){
                                $eksekusi = $db->input_persentase($_POST['persentase_kpi'], $_POST['persentase_kompetensi'], $_POST['id_periode']);
                                if($eksekusi == 2)
                                {
                                ...
                                else if($eksekusi == 1)
                                {
                                    echo '
                                        <script>
                                            ...
                                            window.location = "persentase_nilai.php";
                                        </script>
                                    ';
                                }
                                else if($eksekusi == 3)
                                {
                                    echo '
                                        <script>
                                            alert("Data Sudah Terdapat Pada Periode Tersebut");
                                            window.location = "persentase_nilai.php";
                                        </script>
                                    ';
                                }
                                ...
                                $eksekusi = $db->edit_persentase($_POST['id_persentase_edit'], $_POST['persentase_kpi_edit'], $_POST['persentase_kompetensi_edit'], $_POST['id_periode_edit']);
                            ...
                            {
                                $eksekusi = $db->hapus_persentase($_POST['id_persentase_hapus']);
                                if($eksekusi == 2 || $eksekusi == 3)
                                {
                                    echo '<div class="alert alert-danger">Data Gagal Disimpan</div>';
                                }
						...
						<div class="col-md-12" style="border:1px solid black;color:black; background-color:white; padding:1%;">
							<div class="table-responsive">
								<table class="table table-striped custom-table m-b-0 display" id="tabel">
                                    ...
                                    ?>
                                            <tr>
                                                <td><?php echo $data['persentase_kpi']; ?></td>
                                                <td><?php echo $data['persentase_kompetensi']; ?></td>
                                                <td><?php echo $data['tahun']; ?></td>
                                                <td class="text-right">
                                                    <div class="dropdown">
                                                        <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                                        <ul class="dropdown-menu pull-right">
                                                            <li><a href="#" title="Edit" data-toggle="modal" data-target="#edit_ticket<?php echo $data['id_persentase']; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a></li>
                                                            <li><a href="#" title="Delete" data-toggle="modal" data-target="#delete_ticket<?php echo $data['id_persentase']; ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <!-- Modal Edit -->
                                            <div id="edit_ticket<?php echo $data['id_persentase']; ?>" class="modal custom-modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    <div class="modal-content modal-lg">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Edit Data Persentase Nilai</h4>
                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label>Periode</label>
                                                                            <input class="form-control" type="hidden" name="id_persentase_edit" value="<?php echo $data['id_persentase']; ?>">
                                                                            <select name="id_periode_edit" id="id_periode_edit" class="form-control cek">
                                                                                <?php
                                                                                    foreach($db->tampil_periode() as $tE)
                                                                                    {
                                                                                        if($tE['status'] == 1)
                                                                                        {
                                                                                            $s = '';
                                                                                            if($tE['id_periode'] == $data['id_periode'])
                                                                                                $s = 'selected="selected"';
                                                                                            echo '<option value="'.$tE['id_periode'].'">'.$tE['tahun'].'</option>';
                                                                                        }
                                                                                    }
                                                                                ?>
                                                                            </select>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label>Persentase KPI</label>
                                                                            <input class="form-control cek" type="text" name="persentase_kpi_edit" value="<?php echo $data['persentase_kpi']; ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label>Persentase Kompetensi</label>
                                                                            <input class="form-control cek" type="text" name="persentase_kompetensi_edit" value="<?php echo $data['persentase_kompetensi']; ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="m-t-20 text-center">
                                                                    <button class="btn btn-primary" type="submit" name="tombolEdit">Edit Data Persentase Nilai</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
                                            ...
                                            <!-- Modal Hapus -->
                                            <div id="delete_ticket<?php echo $data['id_persentase']; ?>" class="modal custom-modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content modal-md">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Hapus Persentase Nilai</h4>
                                                        </div>
                                                        <form method="POST" action="#">
                                                            <div class="modal-body card-box">
                                                                <p>Yakin Untuk Menghapus Persentase Nilai Periode <?php echo $data['tahun']; ?> ?</p>
                                                                <input type="hidden" name="id_persentase_hapus" value="<?php echo $data['id_persentase']; ?>">
			...
			<div id="add_ticket" class="modal custom-modal fade" role="dialog">
				<div class="modal-dialog">
					...
					<div class="modal-content modal-lg">
						<div class="modal-header">
							<h4 class="modal-title">Tambah Data Persentase Nilai</h4>
						</div>
						<div class="modal-body">
							<form method="POST" action="#" id="golongan_input">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label>Periode</label>
											<select name="id_periode" id="id_periode" class="form-control cek">
                                                <?php
									...
									<div class="col-md-6">
										<div class="form-group">
											<label>Persentase KPI</label>
											<input class="form-control cek" type="text" name="persentase_kpi">
										</div>
									</div>
								</div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Persentase Kompetensi</label>
                                            <input class="form-control cek" type="text" name="persentase_kompetensi">
                                        </div>
									</div>
                                </div>
								<div class="m-t-20 text-center">
									<button class="btn btn-primary" type="submit" name="tombolSimpan">Simpan Data Persentase Nilai</button>
								</div>
							</form>
						</div>
					</div>
