        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-8">
							<h4 class="page-title">Master Kriteria Nilai</h4>
						</div>
								...
								<table class="table table-striped custom-table m-b-0 display" id="tabel">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>(jumlah : <?php echo ($db->hitung_kriteria($data['id_periode'])); ?>) <a href="detail_kriteria.php?id_periode=<?php echo $data['id_periode']; ?>">Detail</a></td>
                                            </tr>
                                    <?php
                                        }
                                    ?>
