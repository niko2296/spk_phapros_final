        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<h4 class="page-title">Detail Polarisasi (<b>Periode 
                                <?php
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php
                                ...
                                {
                                    $eksekusi = $db->hapus_polarisasi($_POST['id_polarisasi_hapus'], $id_periode);
                                    if($eksekusi == 2 || $eksekusi == 3)
                                    {
                                        echo '<div class="alert alert-danger">Data Gagal Disimpan</div>';
                                    }
					...
					<div class="row" style="border:1px solid black;color:black; background-color:white; padding:1%;">                        
							...
							<div class="table-responsive">
                                <table class="table table-striped custom-table m-b-0 display" id="tabel">
                                    ...
                                    <?php
                                        $no = 0;
                                        error_reporting(0);
                                        foreach($db->tampil_polarisasi($id_periode) as $data)
                                        {
                                            $no = $no+1;
                                    ?>
                                            <tr>
                                            ...
                                            <!-- Modal Copy -->
                                            <div id="copy<?php echo $data['id_polarisasi']; ?>" class="modal custom-modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content modal-md">
                                                        <div class="modal-header">
                        ...
                        <div class="col-md-12" align="right">
                            <a href="data_polarisasi.php" title="Kembali">
