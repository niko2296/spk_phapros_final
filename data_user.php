    ...
    <body>
                ...
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-12">
                            ...
                            <center><div style="background-color:#7CFC00; width:40%; color:white; padding:5px; display:none;" id="notifikasi3">Password Telah Direset</div></center>
                            ...
                            <center><div style="background-color:red; width:40%; color:white; padding:5px; display:none;" id="notifikasi4">Password Gagal Direset</div></center>
						</div>
					</div>
					<div class="row">
							...
							<div class="table-responsive">
								<table class="table table-striped custom-table m-b-0 display" id="tabel">
                                    ...
                                    <?php
                                        $no = 0;
                                        error_reporting(0);
                                        foreach($db->tampil_user() as $data)
                                        {
                                            $no = $no+1;
                                    ?>
                                            <tr>
                                                ...
                                                <?php
                                                    ...
                                                    {
                                                ?>
                                                        <input data-id="<?php echo $data['id_user']; ?>" data-field="status" data-jenis="verifikasi" type="checkbox" id='verifikasi1' <?php echo ($data['status'] == 1)?'checked':''; ?>>
                                                <?php
                                                    }
                                                    else {
                                                        echo ($data['status'] == 1)?'Aktif':'Tidak Aktif';
                                                    }
                                                ?>
                                                </center></td>
                                                <td><center>
                                                    <?php
                                                        ...
                                                        {
                                                    ?>
                                                            <input data-id="<?php echo $data['id_user']; ?>" data-field="aksus" data-jenis="verifikasi" type="checkbox" id='verifikasi1' <?php echo ($data['aksus'] == 1)?'checked':''; ?>>
                                                    <?php
                                                        }
                                                        else {
                                                            echo ($data['aksus'] == 1)?'Ya':'Tidak';
                                                        }
                                                    ?>
                                                </center></td>
                                                <td><center><a href="#" class="btn btn-success" id='verifikasi2' data-jenis="reset" data-id="<?php echo $data['id_user']; ?>" data-username="<?php echo $data['username']; ?>">Reset</a></center></td>
                                            </tr>
                                    <?php
                                        }
                                    ?>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#notifikasi3").css("display","none");
                $("#notifikasi4").css("display","none");
                ...
                $('#tabel').on('click','#verifikasi2',function(e){
                    $.ajax({
                        url : 'verifikasi_final.php',
                        type : 'get',
                        data:{
                        ...
                        success:function(html){
                            if(html == 1)
                            {
                                $(document).ready(function(){setTimeout(function(){$("#notifikasi3").fadeIn('slow');}, 300);});
                                setTimeout(function(){$("#notifikasi3").fadeOut('#notifikasi3');}, 1500);
                            }
                            else if(html == 2)
                            {
                                $(document).ready(function(){setTimeout(function(){$("#notifikasi4").fadeIn('slow');}, 300);});
                                setTimeout(function(){$("#notifikasi4").fadeOut('#notifikasi4');}, 1500);
                            }
                        }
                    });
                });
