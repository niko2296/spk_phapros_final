                                    ...
                                    if($eksekusi == 2 || $eksekusi == 3)
                                        ...
                                        echo '
                                            <script>
                                                ...
                                                window.location = "detail_kpi.php?id_anggota='.$id_anggotaD.'&&id_jabatan='.$id_jabatanD.'&&id_departemen='.$id_departemenD.'&&id_unit='.$id_unitD.'";
                                            </script>
                                        ';
                                }
