...
<html>
    ...
    <body>
        <div class="main-wrapper">
            ...
            <?php
                $id_matriks = $_GET['id_matriks'];
                if($id_matriks != null)
                {
                    foreach($db->tampil_aturan_matriks($id_matriks) as $tE)
                    {
                        $arrJabatan = $tE['id_jabatan'];
                        $id_unitE = $tE['id_unit'];
                    }
                }
                else {
                    echo '
                        <script>
                            alert("Silahkan Pilih Data yang Ingin Di-Edit");
                ...
                {
                    $id_matriks = $_POST['id_matriks'];
                    $id_jabatan = $_POST['id_jabatan'];
                    $id_unit = $_POST['id_unit'];

                    $eksekusi = $db->edit_matriks($id_matriks, $id_jabatan, $id_unit);
                    if($eksekusi == 1)
                    {
                        echo '
                            <script>
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-8">
							<h4 class="page-title">Edit Perhitungan Matriks</h4>
						</div>
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <form action="#" method="POST" id="penilai_input">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="id_matriks" value="<?php echo $id_matriks; ?>">
                                            <select name="id_jabatan[]" id="id_jabatan" class="form-control cek" multiple="multiple">
                                                ...
                                                <?php
                                                    ...
                                                    {
                                                        $s = '';
                                                        if(in_array($tampil['id_jabatan'], $id_jabatanE))
                                                            $s = 'selected="selected"';
                                                        
                                                        echo '<option value="'.$tampil['id_jabatan'].'" '.$s.'>'.$tampil['nama_jabatan'].'</option>';
                                                    }
                                                ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="id_unit" id="id_unit" class="form-control cek">
                                                ...
                                                <?php
                                                    ...
                                                    {
                                                        $s = '';
                                                        if($tampil['id_unit'] == $id_unitE)
                                                            $s = 'selected="selected"';
                                                        
                                                        echo '<option value="'.$tampil['id_unit'].'" '.$s.'>'.$tampil['nama_unit'].'</option>';
                                                    }
                                                ?>
                                            </select>
                                        </div>
                                ...
                                <div class="m-t-20 text-center">
                                    <button class="btn btn-primary" type="submit" name="tombolEdit">Edit Data Perhitungan Matriks</button>
                                </div>
                            </form>
                        </div>
                    </div>
