                ...
                <div class="content container-fluid">
						...
						<div class="col-xs-12">
							<h4 class="page-title">
                                <?php
                                    ...
                                    echo 'Detail Kompetensi Sub Ordinat Mutasi <b>('.$nj.' - '.$nd.' - '.$nu.')</b>';
                                ?>
                            </h4>
						</div>
					</div>
                                ...
                                <table class="table table-striped custom-table m-b-0 display" id="tabel2">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><a href="detail_ks_mutasi.php?id_anggota=<?php echo $data['id_anggota']."&&id_jabatan_lama=".$data['id_jabatan_lama']."&&id_departemen_lama=".$data['id_departemen_lama']."&&id_unit_lama=".$data['id_unit_lama']; ?>">Detail</a></td>
                                            </tr>
                                    <?php
                                        }
                                    ?>
                    ...
                    <div class="row">
                        <div class="col-md-12" align="right">
                            <a class="btn btn-warning" href="kompetensi_sub_mutasi.php">Kembali Halaman Sebelumnya</a>
                        </div>
                    </div>
                </div>
            </div>
