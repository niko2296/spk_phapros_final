					...
					<div class="row">
                        ...
                        <?php
                            if(isset($_POST['tombolSimpan'])){
                                ...
                                $eksekusi = $db->input_awal_input($tanggal1, $tanggal2);
                                if($eksekusi == 2)
                                {
                                ...
                                $tanggal2 = $a2[2].'-'.$a2[1].'-'.$a2[0];
                                $eksekusi = $db->edit_awal_input($_POST['id_waktu_edit'], $tanggal1, $tanggal2);
							...
							<form method="POST" action="#">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label>Tanggal Awal Input</label>
											<div class="cal-icon"><input class="form-control datetimepicker" type="text" name="tanggal_awal_input" id="tanggal_awal_input" placeholder="dd/mm/yyyy"></div>
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="form-group">
											<label>Tanggal Akhir Input</label>
                                            <div class="cal-icon"><input class="form-control datetimepicker" type="text" name="tanggal_akhir_input" id="tanggal_akhir_input" placeholder="dd/mm/yyyy"></div>
										</div>
									</div>
								</div>
								<div class="m-t-20 text-center">
