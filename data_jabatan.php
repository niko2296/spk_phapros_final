                ...
                <div class="content container-fluid">
					<div class="row">
						...
						<div class="col-xs-4 text-right m-b-30">
							<a href="#" class="btn btn-primary rounded pull-right" data-toggle="modal" data-target="#add_ticket"><i class="fa fa-plus"></i> Tambah Jabatan</a>
						</div>
					</div>
					<div class="row">
                        ...
                        <?php
                            ...
                            {
                                $eksekusi = $db->hapus_jabatan($_POST['id_jabatan_hapus']);
                                if($eksekusi == 2 || $eksekusi == 3)
                                {
                                    echo '<div class="alert alert-danger">Data Gagal Disimpan</div>';
                                }
							...
							<div class="table-responsive">
								<table class="table table-striped custom-table m-b-0 display" id="tabel">
                                    ...
                                    ?>
                                                ...
                                                <td class="text-right">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu pull-right">
                                                            <li><a href="#" title="Edit" data-toggle="modal" data-target="#edit_ticket<?php echo $data['id_jabatan']; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a></li>
                                                            <li><a href="#" title="Delete" data-toggle="modal" data-target="#delete_ticket<?php echo $data['id_jabatan']; ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <!-- Modal Edit -->
                                            <div id="edit_ticket<?php echo $data['id_jabatan']; ?>" class="modal custom-modal fade" role="dialog">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST" action="#">
                                                                ...
                                                                <div class="m-t-20 text-center">
                                                                    <button class="btn btn-primary" type="submit" name="tombolEdit">Edit Data Jabatan</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
                                            ...
                                            <!-- Modal Hapus -->
                                            <div id="delete_ticket<?php echo $data['id_jabatan']; ?>" class="modal custom-modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content modal-md">
                                                        ...
                                                        <form method="POST" action="#">
                                                            <div class="modal-body card-box">
                                                                <p>Yakin Untuk Menghapus Jabatan <?php echo $data['nama_jabatan']; ?> ?</p>
                                                                <input type="hidden" name="id_jabatan_hapus" value="<?php echo $data['id_jabatan']; ?>">
